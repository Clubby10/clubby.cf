...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
      url = 'https://discord.com/users/1042544142196154438';
      break;
    case 'github':
      url = 'https://github.com/Clubby10';
      break;
    case 'twitter':
      url = 'https://twitter.com/Clubby102';
      break;
  }
...
function startIntroTyping() {
  new TypeIt('#intro-text', {
    ...
    .type('wagwan waste yute.', { delay: 1200 })
    .delete(null, { delay: 1000 })
    .type(`${mobile ? 'tap' : 'press any key'} to enter bumbaclat.`)
    .go();
...
function typerStartTyping(typer) {
  ...
  let text = ['c++', 'paypal', 'minecraft', 'roleplay'];
